 ...
 */
class Webqem_Mailcall_Model_Resource_Carrier_Timeslots extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $this->_init('webqemmailcall/timeslots', 'pk');
    }
